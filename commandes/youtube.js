...
_*RUSH-V1-MD SONG DOWNLOADING😍......*_\n\n`
       }
...
_*RUSH-V1-MD VIDEO DOWNLOADING😍......*_\n\n`
      };
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "*RUSH-V1-MD*", gifPlayback: false }, { quoted: ms });
      });
